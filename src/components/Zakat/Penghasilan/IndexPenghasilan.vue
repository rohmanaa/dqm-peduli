<template>
    <div class="single-post-area">
        ...
        <p>
            ...
            hal yang diinginkan manusia untuk disimpan dan dimiliki” (Lisan ul-Arab). Menurut Islam sendiri, harta merupakan
            sesuatu yang boleh atau dapat dimiliki dan digunakan (dimanfaatkan) sesuai kebutuhannya.
        </p>
        <p>Oleh karena itu dalam pengertiannya, zakat maal berarti zakat yang dikenakan atas segala jenis harta, yang secara
            zat maupun substansi perolehannya tidak bertentangan dengan ketentuan agama.Sebagai contoh, zakat maal terdiri
            atas simpanan kekayaan seperti uang, emas, surat berharga, penghasilan profesi, aset perdagangan, hasil barang
            tambang atau hasil laut, hasil sewa aset dan lain sebagainya.</p>
        <p>Sebagaimana yang dijelaskan oleh Syaikh Dr. Yusuf Al-Qardhawi dalam kitabnya Fiqh uz-Zakah, zakat maal meliputi:
        </p>
