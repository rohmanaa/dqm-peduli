                                    ...
                                    <div class="contact-form">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" v-model="emasmilik" @input="hitungZakat" />
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" :value="formatNumber(totalBayarEmas)" disabled />
                                            </div>
    ...
    methods: {
        ...
        hitungZakat() {
            if (this.emasmilik >= 85) {
                this.isZakatEmasRequired = true;
                this.totalBayarEmas = this.emasmilik * 0.025 * this.hargaemas;
            } else {
                this.isZakatEmasRequired = false;
