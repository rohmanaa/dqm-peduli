...
<div>
    <div class="container pt-5">
        <b-carousel class="slider-home" id="carousel-1" v-model="slide" :interval="4000" controls indicators background="transparent" img-width="100" style="text-shadow: 1px 1px 2px" @sliding-start="onSlideStart" @sliding-end="onSlideEnd">
